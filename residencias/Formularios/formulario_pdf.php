...
if (isset($_GET['id'])) {
    ...
    if (!isset($asesorInterno))
        $asesorInterno = new Responsable(1, "", "img/image.jpg");
    if (!isset($revisor1))
        $revisor1 = new Responsable(1, "", "img/image.jpg");
    if (!isset($revisor2))
        $revisor2 = new Responsable(1, "", "img/image.jpg");

    if ($asesorInterno->getIdUsuario() == 1)
        $asesorInterno->setNombre("");
    if ($revisor1->getIdUsuario() == 1)
        $revisor1->setNombre("");
    if ($revisor2->getIdUsuario() == 1)
        $revisor2->setNombre("");
