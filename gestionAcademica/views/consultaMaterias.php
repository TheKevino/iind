...
<div class="container mt-2">
    ...
    <h3>Consulta Materias</h3>
    <div class="row md-12">

        <div class="card card-body col-md-12 mt-4 mb-4">
            <div class="row">
                <div class="col-md-12 justify-content-center">
                    <input type="text" class="form-control" id="buscador_materia" name="buscador_materia" autocomplete="off" placeholder="Informacion de la materia">
                    <button class="btn btn-secundario mt-4" name="btnBuscarMateria" id="btnBuscarMateria">Buscar</button>
                </div>
            </div>
        </div>
...
<div class="container">
    <section id="tabla_materias">

    </section>
</div>

<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous"></script>
<script src="gestionAcademica/js/consulta_materias.js"></script>
</body>
</html>