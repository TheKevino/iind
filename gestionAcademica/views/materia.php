    ...
    <div class="row col-md-12">
      ...
      <div class="col-md-4">
        <input class="form-control m-2" type="text" name="nombreMateria" id="nombreMateria"
          placeholder="Nombre de la materia" oninput="validarSoloLetras(this.id)" />
      </div>

      <div class="col-md-4">
        <input class="form-control m-2" type="text" name="satca" id="satca" placeholder="SATCA. Ej: 2-3-5" oninput="validarNumerosYGuiones(this.id)"/>
      </div>
    </div>
    ...
    <div class="row col-md-12">
      <div class="col-md-12">
        <textarea class="form-control m-2" name="caracterizacion" id="caracterizacion"
          placeholder="Caracterización de la asignatura (Opcional)"></textarea>
      </div>
    </div>
    ...
    <div class="row col-md-12">
      <div class="col-md-12">
        <textarea class="form-control m-2" name="intencion" id="intencion"
          placeholder="Intención didactica (Opcional)."></textarea>
      </div>
    </div>
    ...
    <div class="row col-md-12">
      <div class="col-md-4">
        <textarea class="form-control m-2" name="previas" id="previas"
          placeholder="Competencias previas (Opcional)."></textarea>
      </div>

      <div class="col-md-4">
        <textarea class="form-control m-2" name="genericas" id="genericas"
          placeholder="Competencias genericas (Opcional)."></textarea>
      </div>

      <div class="col-md-4">
        <textarea class="form-control m-2" name="especificas" id="especificas"
          placeholder="Competencias especificas (Opcional)."></textarea>
      </div>
    </div>
    ...
    <div class="row col-md-12">
      <div class="col-md-6">
        <textarea class="form-control m-2" name="fuentes" id="fuentes"
          placeholder="Fuentes de información (Opcional)."></textarea>
      </div>

      <div class="col-md-6">
        <textarea class="form-control m-2" name="apDidacticos" id="apDidacticos"
          placeholder="Apoyos didacticos (Opcional)."></textarea>
      </div>
    </div>
